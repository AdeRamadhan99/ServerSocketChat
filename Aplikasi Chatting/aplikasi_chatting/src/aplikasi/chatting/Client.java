...
public class Client extends JFrame implements ActionListener {
  ...
  Client() {
    ...
    //Navbar - Foto Profil
    ImageIcon photoProfile_1 = new ImageIcon(ClassLoader.getSystemResource("aplikasi/chatting/icons/emoticon-with-happy-face.png"));
    ...
    photoProfile_label.setBounds(35, 5, 60, 60);
    ...
    iconVideo_label.setBounds(230, 5, 60,60);
    ...
    iconPanggilan_label.setBounds(275, 5, 60,60);
    ...
    icon3Dots_label.setBounds(315, 5, 60,60);
    navbar.add(icon3Dots_label);

    //Navbar - Username
    JLabel username_label = new JLabel("Client Admin");
    ...
    pesanDisplay.setBounds(5, 5, 340, 470);
    ...
    pesanField.setBounds(15, 15, 310, 40);
    ...
    iconSend_label.setBounds(325, 8, 55,55);
